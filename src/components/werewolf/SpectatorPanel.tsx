          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div className="space-y-1">
              ...
              <div
                ...
                data-testid="werewolf-spectator-match-id"
              >
            ...
            <div className="flex flex-wrap items-center gap-4">
              <div className="text-right">
                ...
                <div className="text-lg" data-testid="werewolf-spectator-day">
                  {state?.dayNumber ?? '--'}
                </div>
              </div>
              <div className="text-right">
                <div className="text-[12px] uppercase tracking-widest text-white/40">Phase</div>
                <div className="text-lg" data-testid="werewolf-spectator-phase">
                  {state ? formatPhaseLabel(state.phase) : '--'}
                </div>
              </div>
              <div className="text-right">
            ...
            <div className="grid min-h-0 flex-1 gap-4 overflow-x-hidden overflow-y-auto px-6 py-4 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1.6fr)_minmax(0,0.9fr)] lg:overflow-hidden">
              <section className="flex min-h-0 flex-col gap-4">
                ...
                <div className="flex items-center justify-between text-[12px] uppercase tracking-[0.3em] text-white/50">
                  <span>Stage</span>
                  <span className="text-white/60" data-testid="werewolf-spectator-players-alive">
                ...
                <div className="relative mt-2 flex min-h-0 flex-1">
                  ...
                  <div
                    className="relative grid h-full grid-cols-2 auto-rows-fr gap-2"
                    data-testid="werewolf-roster"
                  >
                    {players.map((player) => {
              ...
              <section className="flex min-h-0 flex-col gap-3">
                ...
                <div className="flex-1 overflow-hidden rounded-lg border border-[#222a3b] bg-[#0f1422]">
                  <div
                    className="h-full space-y-3 overflow-y-auto px-4 py-4 text-base"
              ...
              <aside className="flex min-h-0 flex-col gap-4">
                ...
                >
                  ...
                  {state.phase === 'DAY_VOTE' ? (
                    <div className="mt-2 space-y-3 text-base" data-testid="werewolf-vote-tally">
                      {voteTally.length > 0 ? (
                        voteTally.map((entry) => (
                          <div
                ...
                <div className="flex min-h-0 flex-1 flex-col rounded-lg border border-[#222a3b] bg-[#0f1422] px-4 py-3">
                  ...
                  <div
                    className="mt-2 flex min-h-0 flex-1 flex-col space-y-2 overflow-y-auto pr-1 text-base"
                    data-testid="werewolf-key-moments"
                  >
                    {keyMoments.length > 0 ? (
                ...
                <div className="rounded-lg border border-[#222a3b] bg-[#0f1422] px-4 py-3">
                  ...
                  <div className="mt-2 text-base text-white/80" data-testid="werewolf-spectator-summary">
